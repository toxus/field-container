...
class fieldBase {
  ...
  /**
   * compares the value of two fields. SHOULD BE OF THE SAME TYPE!!!!
   * @param field
   */
  isEqual(thisField, thatField, options = {usage: true}) {
    if (options.usage) {
      return this.usageCompare(thisField.usage, thatField.usage);
    }
    return true;
  }
}
